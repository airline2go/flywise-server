...
describe('generated route SEO truthfulness', () => {
  ...
  test('effectiveRouteSeo keeps manual content and suppresses unsafe generated content', () => {
    const effective = effectiveRouteSeo({
      ...
      seo_title: 'Flüge von London nach Zürich – Preise | Airpiv',
      seo_meta_description: 'Diese Dichte drückt die Preise auf dieser Strecke.',
      seo_intro_html: '<p>Ein Vorlauf von zwei bis drei Wochen ist ideal.</p>',
      seo_faq: [
        { question: 'Wie lange?', answer: '105 Minuten beobachtet.' },
        { question: 'Wann buchen?', answer: 'Zwei bis drei Wochen sind ideal.' },
      ],
    });
  ...
  test('quality gate rejects unsupported generated claims before persistence', () => {
    const result = validateGeneratedSeo(route, {
      title: 'Flüge von London nach Zürich – Preise, Flugzeit & Airlines | Airpiv',
      metaDescription: 'Vergleiche Flugpreise, Flugzeit, Airlines und Direktflüge von London nach Zürich. Prüfe die verfügbaren Routendaten auf Airpiv.',
      introPlain: 'Ein Vorlauf von zwei bis drei Wochen ist ideal für diese Strecke.',
      sections: [
        { heading: 'Airlines', body: '8 Airlines sind im Routendatensatz vertreten.' },
        { heading: 'Buchungsstrategie', body: 'Dienstag und Mittwoch sind meist günstiger.' },
      ],
      faq: [
        { question: 'Wie lange?', answer: '105 Minuten beobachtet.' },
        { question: 'Wann buchen?', answer: 'Zwei bis drei Wochen sind ideal.' },
    ...
    expect(result.reasons).toEqual(expect.arrayContaining(['unsupported intro claim', 'unsupported section claim', 'unsupported FAQ claim']));
  });
});
