...
module.exports = {
  ...
  // Shared secret injected by the trusted Cloudflare edge. Keep unset until
  // the Cloudflare Request Header Transform is configured; once set, the API
  // shield can enforce that public API traffic arrived through Cloudflare.
