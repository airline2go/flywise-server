...
const UNSUPPORTED = [
  ...
  /\b(?:andere|anderen|anderer|anderem|alternative|other|alternate|alternativen?)\b[^.]{0,80}\b(?:flughäfen?|airports?|aéroports?|aeropuertos?|aeroporti|havaalanları)\b/i,
];
