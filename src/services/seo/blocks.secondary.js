...
const overviewCopy = {
  ...
  tr: c => c.o + ' ile ' + c.d + ' kuş uçuşu yaklaşık ' + Math.round(c.km) + ' km uzaklıktadır. ' + (formatDuration(lang, c.durMin) ? 'Gözlemlenen uçuş süresi yaklaşık ' + formatDuration(lang, c.durMin) + '. ' : '') + (c.airlineCount ? c.airlineCount + ' ' + airPlural + ' rota verilerinde yer alıyor. ' : '') + 'Rota ' + haulLabel(c) + ' olarak sınıflandırılmıştır.',
}[lang];
